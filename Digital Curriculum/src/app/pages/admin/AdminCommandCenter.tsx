...
export function AdminCommandCenter() {
  ...
  const adminTools: ToolDef[] = [
    ...
    },
    {
      ...
      description: "Push activity feed and manual sends",
      href: adminPanelPath("push-notifications"),
    ...
    },
    {
      ...
      description: "Custom Brevo announcements to students and alumni",
      href: adminPanelPath("email-management"),
    ...
    },
    {
      icon: FlaskConical,
      title: "Email testing",
      description: "Send sample Brevo templates to any inbox for QA",
      href: adminPanelPath("email-testing"),
      gradient: "from-orange-500/20 to-orange-500/5",
      iconColor: "text-orange-500",
      stats: "Test",
      scope: "digital_curriculum",
