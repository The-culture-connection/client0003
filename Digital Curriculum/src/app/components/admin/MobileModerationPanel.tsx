  ...
  return (
    <div className="space-y-10 max-w-7xl">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <h2 className="text-xl font-semibold text-foreground mb-2">Create mobile community</h2>
        ...
        <Card className="p-6 border-border bg-card">
          <h2 className="text-xl font-semibold text-foreground mb-2">Manage mobile communities</h2>
          <p className="text-sm text-muted-foreground mb-4">
            All <code className="text-xs bg-muted px-1">groups_mobile</code> communities (live). Select one to edit
            metadata or members. Uses Cloud Functions (
            <code className="text-xs bg-muted px-1">adminUpdateMobileGroup</code>,{" "}
            <code className="text-xs bg-muted px-1">adminModifyMobileGroupMembers</code>) so staff who only have
            Firestore <code className="text-xs bg-muted px-1">Admin</code> in{" "}
            <code className="text-xs bg-muted px-1">users</code> (no Auth token{" "}
            <code className="text-xs bg-muted px-1">roles</code> claim) can still manage groups.
          </p>
          {mobileGroupsErr ? (
          ...
          <div className="space-y-4">
            ...
            {selectedGroupId ? (
              <div className="space-y-4 pt-2 border-t border-border/60">
                ...
                <div>
                  <Label className="text-foreground">Rules</Label>
                  <Textarea
                    className="mt-1"
                    value={editRules}
                ...
                <div className="space-y-2 pt-2 border-t border-border/60">
                  <Label className="text-foreground">Members ({memberUids.length})</Label>
